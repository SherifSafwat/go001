...
type GetProductsParams struct {
	// Page How many items to return at one time (max 100)
...
type ServerInterface interface {
	...
	// Delete a product
	// (DELETE /products/{id})
	DeleteProduct(w http.ResponseWriter, r *http.Request, id int)
	// Get a product by ID
	// (GET /products/{id})
	GetProductById(w http.ResponseWriter, r *http.Request, id int)
	// Update a product
	// (PUT /products/{id})
...
// Delete a product
// (DELETE /products/{id})
func (_ Unimplemented) DeleteProduct(w http.ResponseWriter, r *http.Request, id int) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get a product by ID
// (GET /products/{id})
func (_ Unimplemented) GetProductById(w http.ResponseWriter, r *http.Request, id int) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Update a product
// (PUT /products/{id})
func (_ Unimplemented) UpdateProduct(w http.ResponseWriter, r *http.Request, id int) {
	w.WriteHeader(http.StatusNotImplemented)
}
